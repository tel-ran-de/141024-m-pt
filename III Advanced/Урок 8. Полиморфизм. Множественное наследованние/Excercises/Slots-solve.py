...
def main():
    ...
    # сравнение памяти
    print(f'Memory allocation for object Point: {dict_obj.__sizeof__() + dict_obj.__dict__.__sizeof__()} b')
    print(f'Memory allocation for object Point2: {slots_obj.__sizeof__()} b')

    # сравнение времени
    # t1 = timeit.timeit(slots_obj)
    # t2 = timeit.timeit(dict_obj)
