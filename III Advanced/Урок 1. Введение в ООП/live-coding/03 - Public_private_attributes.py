...
# Доступ к приватному атрибуту через метод-геттер
print(person.get_age())

# Установка приватного атрибута через метод-сеттер
person.set_age(25)
print(person.get_age())
...
picasso = Artist("Pablo Picasso", 1881, "Cubism")
print(picasso.genre)
print(picasso.get_age())
